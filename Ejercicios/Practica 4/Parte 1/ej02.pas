...
Al finalizar, debe retornar el vector y su dimensión lógica.
La lectura finaliza cuando se ingresa el valor 0 (que no debe procesarse) o cuando el vector está completo.

b) El módulo modificarVectorYSumar debe devolver el vector con todos sus elementos incrementados con el valor n y 
